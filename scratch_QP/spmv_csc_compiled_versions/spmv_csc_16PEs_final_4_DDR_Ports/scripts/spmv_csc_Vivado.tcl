...
# Add AXI Timer for precise cycle counting
...
# Connect the AXI Timer to the control network
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Master {/zynq_ultra_ps_e_0/M_AXI_HPM0_FPD} intc_ip {Auto} master_apm {0}}  [get_bd_intf_pins axi_timer_0/s_axi]
