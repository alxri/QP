...
# 2 "<built-in>" 2
# 1 "../src/mv.cpp" 2
# 1 "/home/romoirib/QP/mv/HLS/include/mv.h" 1





__attribute__((sdx_kernel("mv", 0))) void mv(const float *A, const float *x, float *y, int rows, int columns);
# 2 "../src/mv.cpp" 2
__attribute__((sdx_kernel("mv", 0))) void mv(const float *A, const float *x, float *y, int rows, int columns)
{
#line 19 "/home/romoirib/QP/mv/HLS/scripts/create_project.tcl"
#pragma HLSDIRECTIVE TOP name=mv
# 3 "../src/mv.cpp"
