...
# 2 "<built-in>" 2
# 1 "../src/spmv_csr.cpp" 2
# 1 "/home/romoirib/QP/spmv/HLS/include/spmv.h" 1
...
__attribute__((sdx_kernel("spmv_csr", 0))) void spmv_csr(int num_rows, int num_cols, const int *A_row_index, const int *A_col_index, const float *A_values, const float *x, float *y);
# 2 "../src/spmv_csr.cpp" 2

__attribute__((sdx_kernel("spmv_csr", 0))) void spmv_csr(int num_rows, int num_cols, const int *A_row_index, const int *A_col_index, const float *A_values, const float *x, float *y)
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=spmv_csr
# 4 "../src/spmv_csr.cpp"
