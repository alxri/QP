...
set name spmv_csr_fadd_32ns_32ns_32_4_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 3 ALLOW_PRAGMA 1
}


set name spmv_csr_fmul_32ns_32ns_32_3_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_buf \
    op interface \
    ports { x_buf_address0 { O 10 vector } x_buf_ce0 { O 1 bit } x_buf_q0 { I 32 vector } } \
} "
} else {
...
set InstName spmv_csr_flow_control_loop_pipe_sequential_init_U
set CompName spmv_csr_flow_control_loop_pipe_sequential_init
