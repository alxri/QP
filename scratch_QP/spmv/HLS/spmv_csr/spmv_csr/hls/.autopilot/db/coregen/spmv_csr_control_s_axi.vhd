...
entity spmv_csr_control_s_axi is
generic (
...
end entity spmv_csr_control_s_axi;
...
architecture behave of spmv_csr_control_s_axi is
    ...
    constant ADDR_NUM_ROWS_DATA_0    : INTEGER := 16#10#;
    constant ADDR_NUM_ROWS_CTRL      : INTEGER := 16#14#;
    constant ADDR_NUM_COLS_DATA_0    : INTEGER := 16#18#;
    constant ADDR_NUM_COLS_CTRL      : INTEGER := 16#1c#;
    constant ADDR_A_ROW_INDEX_DATA_0 : INTEGER := 16#20#;
    constant ADDR_A_ROW_INDEX_DATA_1 : INTEGER := 16#24#;
    constant ADDR_A_ROW_INDEX_CTRL   : INTEGER := 16#28#;
    constant ADDR_A_COL_INDEX_DATA_0 : INTEGER := 16#2c#;
    constant ADDR_A_COL_INDEX_DATA_1 : INTEGER := 16#30#;
    constant ADDR_A_COL_INDEX_CTRL   : INTEGER := 16#34#;
    constant ADDR_A_VALUES_DATA_0    : INTEGER := 16#38#;
    constant ADDR_A_VALUES_DATA_1    : INTEGER := 16#3c#;
    constant ADDR_A_VALUES_CTRL      : INTEGER := 16#40#;
    constant ADDR_X_DATA_0           : INTEGER := 16#44#;
    constant ADDR_X_DATA_1           : INTEGER := 16#48#;
    constant ADDR_X_CTRL             : INTEGER := 16#4c#;
    constant ADDR_Y_DATA_0           : INTEGER := 16#50#;
    constant ADDR_Y_DATA_1           : INTEGER := 16#54#;
    constant ADDR_Y_CTRL             : INTEGER := 16#58#;
    ...
    signal int_num_cols        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_A_row_index     : UNSIGNED(63 downto 0) := (others => '0');
    signal int_A_col_index     : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_NUM_COLS_DATA_0 =>
                        rdata_data <= RESIZE(int_num_cols(31 downto 0), 32);
                    when ADDR_A_ROW_INDEX_DATA_0 =>
                        rdata_data <= RESIZE(int_A_row_index(31 downto 0), 32);
                    when ADDR_A_ROW_INDEX_DATA_1 =>
                        rdata_data <= RESIZE(int_A_row_index(63 downto 32), 32);
                    when ADDR_A_COL_INDEX_DATA_0 =>
                        rdata_data <= RESIZE(int_A_col_index(31 downto 0), 32);
                    when ADDR_A_COL_INDEX_DATA_1 =>
                        rdata_data <= RESIZE(int_A_col_index(63 downto 32), 32);
...
-- ----------------------- Register logic ----------------
    ...
    num_cols             <= STD_LOGIC_VECTOR(int_num_cols);
    A_row_index          <= STD_LOGIC_VECTOR(int_A_row_index);
    A_col_index          <= STD_LOGIC_VECTOR(int_A_col_index);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_num_cols(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NUM_COLS_DATA_0) then
                    int_num_cols(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_num_cols(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_A_row_index(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_ROW_INDEX_DATA_0) then
                    int_A_row_index(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_A_row_index(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_A_row_index(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_ROW_INDEX_DATA_1) then
                    int_A_row_index(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_A_row_index(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_A_col_index(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_COL_INDEX_DATA_0) then
                    int_A_col_index(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_A_col_index(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_A_col_index(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_COL_INDEX_DATA_1) then
                    int_A_col_index(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_A_col_index(63 downto 32));
                end if;
            end if;
        end if;
    end process;
