...
module spmv_csr_spmv_csr_Pipeline_READ_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [10:0] i_1_reg_139_pp0_iter1_reg;
reg   [31:0] gmem3_addr_read_reg_148;
wire   [63:0] zext_ln23_1_fu_119_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [10:0] i_fu_46;
wire   [10:0] add_ln23_fu_102_p2;
wire    ap_loop_init;
...
wire   [31:0] bitcast_ln25_fu_123_p1;
reg    x_buf_ce0_local;
wire   [31:0] zext_ln23_fu_92_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln23_fu_96_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln23_fu_96_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln23_fu_102_p2 = (ap_sig_allocacmp_i_1 + 11'd1);
...
assign bitcast_ln25_fu_123_p1 = gmem3_addr_read_reg_148;

assign icmp_ln23_fu_96_p2 = (($signed(zext_ln23_fu_92_p1) < $signed(num_cols)) ? 1'b1 : 1'b0);
...
assign x_buf_address0 = zext_ln23_1_fu_119_p1;

assign x_buf_ce0 = x_buf_ce0_local;

assign x_buf_d0 = bitcast_ln25_fu_123_p1;

assign x_buf_we0 = x_buf_we0_local;

assign zext_ln23_1_fu_119_p1 = i_1_reg_139_pp0_iter1_reg;

assign zext_ln23_fu_92_p1 = ap_sig_allocacmp_i_1;

endmodule //spmv_csr_spmv_csr_Pipeline_READ_X
