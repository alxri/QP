...
"""
Auto-generated by CVXPYgen on May 15, 2026 at 10:03:21.
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.var_dict['X'].save_value(np.array(res.cpg_prim.X).reshape((6, 43), order='F'))
    prob.var_dict['U'].save_value(np.array(res.cpg_prim.U).reshape((3, 42), order='F'))
    prob.constraints[0].save_dual_value(np.array(res.cpg_dual.d0).reshape((6, 42), order='F'))
    prob.constraints[1].save_dual_value(np.array(res.cpg_dual.d1).reshape((3, 42), order='F'))
