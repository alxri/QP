set moduleName spmv_csr_Pipeline_READ_X
set isTopModule 0
...
set cdfgNum 5
set C_modelName {spmv_csr_Pipeline_READ_X}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict x_buf { MEM_WIDTH 32 MEM_SIZE 4096 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem3 int 32 regular {axi_master 0}  }
	{ num_cols int 32 regular  }
	{ sext_ln23 int 62 regular  }
	{ x_buf float 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ x_buf_address0 sc_out sc_lv 10 signal 3 } 
	{ x_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ x_buf_we0 sc_out sc_logic 1 signal 3 } 
	{ x_buf_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	x_buf { ap_memory {  { x_buf_address0 mem_address 1 10 }  { x_buf_ce0 mem_ce 1 1 }  { x_buf_we0 mem_we 1 1 }  { x_buf_d0 mem_din 1 32 } } }
}
