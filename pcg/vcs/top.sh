...
#
# Script generated by xsim on Wed May 06 13:09:04 CEST 2026
...
#                command in the xsim Tcl shell). After compiling the library, specify the -lib_map_path
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/romoirib/QP/pcg/.cache/compile_simlib/vcs"
  fi
