...
set ip_repo_path "/home/romoirib/QP/spmv_coo/spmv_coo_HW_HLS/solution1/impl/ip"
...
# Step 7: Add IP block Spmv_coo
set spmv_coo_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:spmv_coo:1.0 spmv_coo_0 ]
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Master {/zynq_ultra_ps_e_0/M_AXI_HPM0_FPD} intc_ip {New AXI SmartConnect} master_apm {0}}  [get_bd_intf_pins spmv_coo_0/s_axi_control]
...
connect_bd_intf_net [get_bd_intf_pins spmv_coo_0/m_axi_gmem2] [get_bd_intf_pins smc_gmem2/S00_AXI]
...
connect_bd_intf_net [get_bd_intf_pins spmv_coo_0/m_axi_gmem0] [get_bd_intf_pins smc_gmem0/S00_AXI]
...
connect_bd_intf_net [get_bd_intf_pins spmv_coo_0/m_axi_gmem4] [get_bd_intf_pins smc_gmem4/S00_AXI]
...
connect_bd_intf_net [get_bd_intf_pins spmv_coo_0/m_axi_gmem1] [get_bd_intf_pins smc_gmem1_3/S00_AXI]
connect_bd_intf_net [get_bd_intf_pins spmv_coo_0/m_axi_gmem3] [get_bd_intf_pins smc_gmem1_3/S01_AXI]
