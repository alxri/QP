...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   ();
  ...
  design_1_mv_0_0 mv_0
       (.ap_clk(zynq_ultra_ps_e_0_pl_clk0),
        .ap_rst_n(rst_ps8_0_100M_peripheral_aresetn),
        .m_axi_A_port_ARREADY(1'b0),
        .m_axi_A_port_AWREADY(1'b0),
        .m_axi_A_port_BID(1'b0),
        .m_axi_A_port_BRESP({1'b0,1'b0}),
        .m_axi_A_port_BVALID(1'b0),
        .m_axi_A_port_RDATA({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .m_axi_A_port_RID(1'b0),
        .m_axi_A_port_RLAST(1'b0),
        .m_axi_A_port_RRESP({1'b0,1'b0}),
        .m_axi_A_port_RVALID(1'b0),
        .m_axi_A_port_WREADY(1'b0),
        .m_axi_b_port_ARREADY(1'b0),
        .m_axi_b_port_AWREADY(1'b0),
        .m_axi_b_port_BID(1'b0),
        .m_axi_b_port_BRESP({1'b0,1'b0}),
        .m_axi_b_port_BVALID(1'b0),
        .m_axi_b_port_RDATA({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .m_axi_b_port_RID(1'b0),
        .m_axi_b_port_RLAST(1'b0),
        .m_axi_b_port_RRESP({1'b0,1'b0}),
        .m_axi_b_port_RVALID(1'b0),
        .m_axi_b_port_WREADY(1'b0),
        .m_axi_c_port_ARREADY(1'b0),
        .m_axi_c_port_AWREADY(1'b0),
        .m_axi_c_port_BID(1'b0),
        .m_axi_c_port_BRESP({1'b0,1'b0}),
        .m_axi_c_port_BVALID(1'b0),
        .m_axi_c_port_RDATA({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .m_axi_c_port_RID(1'b0),
        .m_axi_c_port_RLAST(1'b0),
        .m_axi_c_port_RRESP({1'b0,1'b0}),
        .m_axi_c_port_RVALID(1'b0),
        .m_axi_c_port_WREADY(1'b0),
        ...
        .s_axi_control_bus_ARADDR(axi_smc_M01_AXI_ARADDR),
        .s_axi_control_bus_ARREADY(axi_smc_M01_AXI_ARREADY),
        .s_axi_control_bus_ARVALID(axi_smc_M01_AXI_ARVALID),
        .s_axi_control_bus_AWADDR(axi_smc_M01_AXI_AWADDR),
        .s_axi_control_bus_AWREADY(axi_smc_M01_AXI_AWREADY),
        .s_axi_control_bus_AWVALID(axi_smc_M01_AXI_AWVALID),
        .s_axi_control_bus_BREADY(axi_smc_M01_AXI_BREADY),
        .s_axi_control_bus_BRESP(axi_smc_M01_AXI_BRESP),
        .s_axi_control_bus_BVALID(axi_smc_M01_AXI_BVALID),
        .s_axi_control_bus_RDATA(axi_smc_M01_AXI_RDATA),
        .s_axi_control_bus_RREADY(axi_smc_M01_AXI_RREADY),
        .s_axi_control_bus_RRESP(axi_smc_M01_AXI_RRESP),
        .s_axi_control_bus_RVALID(axi_smc_M01_AXI_RVALID),
        .s_axi_control_bus_WDATA(axi_smc_M01_AXI_WDATA),
        .s_axi_control_bus_WREADY(axi_smc_M01_AXI_WREADY),
        .s_axi_control_bus_WSTRB(axi_smc_M01_AXI_WSTRB),
        .s_axi_control_bus_WVALID(axi_smc_M01_AXI_WVALID));
