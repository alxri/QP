; ModuleID = '/home/romoirib/QP/mv/mv/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_mv_ir(float* noalias nocapture nonnull readonly "maxi" %A, float* noalias nocapture nonnull readonly "maxi" %x, float* noalias nocapture nonnull "maxi" %y, i32 %rows, i32 %columns) local_unnamed_addr #0 {
entry:
  %A_copy = alloca float, align 512
  %x_copy = alloca float, align 512
  %y_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %A, float* nonnull align 512 %A_copy, float* nonnull %x, float* nonnull align 512 %x_copy, float* nonnull %y, float* nonnull align 512 %y_copy)
  call void @apatb_mv_hw(float* %A_copy, float* %x_copy, float* %y_copy, i32 %rows, i32 %columns)
  call void @copy_back(float* %A, float* %A_copy, float* %x, float* %x_copy, float* %y, float* %y_copy)
  ret void
}
...
declare void @apatb_mv_hw(float*, float*, float*, i32, i32)
...
declare void @mv_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull, i32, i32)

define void @mv_hw_stub_wrapper(float*, float*, float*, i32, i32) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1, float* null, float* %2)
  call void @mv_hw_stub(float* %0, float* %1, float* %2, i32 %3, i32 %4)
