...
using hls::sim::Byte;
extern "C" void mv(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int, int);
extern "C" void apatb_mv_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y, int __xlx_apatb_param_rows, int __xlx_apatb_param_columns) {
...
__xlx_y__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_y)[i]);
  ...
  // DUT call
  mv(__xlx_A__tmp_vec.data(), __xlx_x__tmp_vec.data(), __xlx_y__tmp_vec.data(), __xlx_offset_byte_param_A, __xlx_offset_byte_param_x, __xlx_offset_byte_param_y, __xlx_apatb_param_rows, __xlx_apatb_param_columns);
