set SynModuleInfo {
  ...
  {SRCNAME mv MODELNAME mv RTLNAME mv IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME mv_A_port_m_axi RTLNAME mv_A_port_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
      {MODELNAME mv_b_port_m_axi RTLNAME mv_b_port_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
      {MODELNAME mv_c_port_m_axi RTLNAME mv_c_port_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
      {MODELNAME mv_control_s_axi RTLNAME mv_control_s_axi BINDTYPE interface TYPE interface_s_axilite}
      {MODELNAME mv_control_bus_s_axi RTLNAME mv_control_bus_s_axi BINDTYPE interface TYPE interface_s_axilite}
    }
  }
}
