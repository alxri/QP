...
CONFIG_HEADER = REPO_ROOT / "HLS" / "include" / "dse_config.h"
...
def main():
    ...
    with open(OUTPUT_CSV, mode='w', newline='') as file:
        ...
        for idx, (pes, size, reshape) in enumerate(combinations):
            ...
            with open(CONFIG_HEADER, 'w') as h_file:
                h_file.write(f"// Auto-generated DSE Config\n")
                h_file.write(f"#ifndef DSE_CONFIG_H\n#define DSE_CONFIG_H\n\n")
                h_file.write(f"#define NUM_PES {pes}\n")
                h_file.write(f"#define MAX_ROWS {size}\n")
                h_file.write(f"#define MAX_COLS {size}\n")
                h_file.write(f"#define RESHAPE_FACTOR {reshape}\n")
                h_file.write(f"\n#endif // DSE_CONFIG_H\n")
