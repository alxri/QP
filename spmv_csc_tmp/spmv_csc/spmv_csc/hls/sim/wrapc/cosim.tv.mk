...
TOOLCHAIN += --gcc-toolchain=/opt/Xilinx/Vivado/2024.2/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/tb_spmv_csc.cpp_pre.cpp.tb.o : tb_spmv_csc.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_spmv_csc.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/spmv_csc.cpp_pre.cpp.tb.o : spmv_csc.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling spmv_csc.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
