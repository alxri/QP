...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vivado/2024.2/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spmv_csc.autotvin.dat"
	set constFileTvOut       "spmv_csc.autotvout.dat"
	set constFileHdlTvIn     "spmv_csc.autohdltvin.dat"
	set constFileHdlTvOut    "spmv_csc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
