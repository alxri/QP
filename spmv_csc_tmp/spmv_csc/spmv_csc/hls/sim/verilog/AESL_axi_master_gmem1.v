...
//------------------------Parameter----------------------
`define TV_IN_gmem1 "../tv/cdatafile/c.spmv_csc.autotvin_gmem1.dat"
`define TV_OUT_gmem1 "../tv/rtldatafile/rtl.spmv_csc.autotvout_gmem1.dat"
...
parameter gmem1_transaction_depth = 32'd 1025;
parameter gmem1_mem_depth = 32'd 1025;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem1_mem_depth) begin
                $display ("/home/romoirib/QP/spmv_csc_tmp/spmv_csc/spmv_csc/hls/sim/verilog/AESL_axi_master_gmem1.v: Write request address %d exceed AXI master gmem1 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem1_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem1_mem_depth) begin
                $display ("/home/romoirib/QP/spmv_csc_tmp/spmv_csc/spmv_csc/hls/sim/verilog/AESL_axi_master_gmem1.v: Read request address %d exceed AXI master gmem1 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem1_mem_depth); 
                $finish;
            end
...
integer gmem1_port0_fresh_depth[0:1];
integer gmem1_port0_blank_depth[0:1];

initial begin : runtime_depth_init_process
    gmem1_port0_fresh_depth[0] = 1025;
...
integer gmem1_cur_trans_depth[0:1];

initial begin : out_depth_init_process
    gmem1_cur_trans_depth[0] = 1025;
end
endmodule
