...
//------------------------Parameter----------------------
`define TV_IN_gmem2 "../tv/cdatafile/c.spmv_csc.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.spmv_csc.autotvout_gmem2.dat"
...
parameter gmem2_transaction_depth = 32'd 12500;
parameter gmem2_mem_depth = 32'd 12500;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/romoirib/QP/spmv_csc_tmp/spmv_csc/spmv_csc/hls/sim/verilog/AESL_axi_master_gmem2.v: Write request address %d exceed AXI master gmem2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/romoirib/QP/spmv_csc_tmp/spmv_csc/spmv_csc/hls/sim/verilog/AESL_axi_master_gmem2.v: Read request address %d exceed AXI master gmem2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
...
integer gmem2_port0_fresh_depth[0:1];
integer gmem2_port0_blank_depth[0:1];

initial begin : runtime_depth_init_process
    gmem2_port0_fresh_depth[0] = 12500;
...
integer gmem2_cur_trans_depth[0:1];

initial begin : out_depth_init_process
    gmem2_cur_trans_depth[0] = 12500;
end
endmodule
