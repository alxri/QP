...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.spmv_csc.autotvin_gmem0.dat"
         "c.spmv_csc.autotvin_gmem1.dat"
         "c.spmv_csc.autotvin_gmem2.dat"
         "c.spmv_csc.autotvin_gmem3.dat"
         "c.spmv_csc.autotvin_num_rows.dat"
         "c.spmv_csc.autotvin_num_cols.dat"
         "c.spmv_csc.autotvin_nnz.dat"
         "c.spmv_csc.autotvin_A_row_idx.dat"
         "c.spmv_csc.autotvin_A_col_ptr.dat"
         "c.spmv_csc.autotvin_A_values.dat"
         "c.spmv_csc.autotvin_x.dat"
         "c.spmv_csc.autotvin_y.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.spmv_csc.autotvout_gmem4.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
