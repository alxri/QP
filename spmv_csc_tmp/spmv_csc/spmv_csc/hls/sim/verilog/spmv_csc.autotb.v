...
`define AUTOTB_DUT      spmv_csc
`define AUTOTB_DUT_INST AESL_inst_spmv_csc
`define AUTOTB_TOP      apatb_spmv_csc_top
`define AUTOTB_LAT_RESULT_FILE "spmv_csc.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "spmv_csc.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_spmv_csc_top
...
`define AESL_DEPTH_num_rows 1
`define AESL_DEPTH_num_cols 1
`define AESL_DEPTH_nnz 1
`define AESL_DEPTH_A_row_idx 1
`define AESL_DEPTH_A_col_ptr 1
`define AESL_DEPTH_A_values 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_gmem2.dat"
`define AUTOTB_TVIN_gmem3_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_gmem3.dat"
`define AUTOTB_TVIN_num_rows_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_num_rows.dat"
`define AUTOTB_TVIN_num_cols_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_num_cols.dat"
`define AUTOTB_TVIN_nnz_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_nnz.dat"
`define AUTOTB_TVIN_A_row_idx_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_A_row_idx.dat"
`define AUTOTB_TVIN_A_col_ptr_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_A_col_ptr.dat"
`define AUTOTB_TVIN_A_values_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_A_values.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_x.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvin_y.dat"
`define AUTOTB_TVOUT_gmem4  "../tv/cdatafile/c.spmv_csc.autotvout_gmem4.dat"
`define AUTOTB_TVOUT_gmem4_out_wrapc  "../tv/rtldatafile/rtl.spmv_csc.autotvout_gmem4.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_A_col_ptr = 1;
parameter LENGTH_A_row_idx = 1;
parameter LENGTH_A_values = 1;
parameter LENGTH_gmem0 = 12500;
parameter LENGTH_gmem1 = 1025;
parameter LENGTH_gmem2 = 12500;
parameter LENGTH_gmem3 = 1024;
parameter LENGTH_gmem4 = 64;
parameter LENGTH_nnz = 1;
parameter LENGTH_num_cols = 1;
parameter LENGTH_num_rows = 1;
...
reg end_num_rows;
reg [31:0] size_num_rows;
reg [31:0] size_num_rows_backup;
reg end_num_cols;
reg [31:0] size_num_cols;
reg [31:0] size_num_cols_backup;
reg end_nnz;
reg [31:0] size_nnz;
reg [31:0] size_nnz_backup;
reg end_A_row_idx;
reg [31:0] size_A_row_idx;
reg [31:0] size_A_row_idx_backup;
reg end_A_col_ptr;
reg [31:0] size_A_col_ptr;
reg [31:0] size_A_col_ptr_backup;
reg end_A_values;
reg [31:0] size_A_values;
reg [31:0] size_A_values_backup;
reg end_x;
reg [31:0] size_x;
