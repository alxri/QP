...
//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.spmv_csc.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.spmv_csc.autotvout_gmem0.dat"
...
parameter gmem0_transaction_depth = 32'd 12500;
parameter gmem0_mem_depth = 32'd 12500;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/romoirib/QP/spmv_csc_tmp/spmv_csc/spmv_csc/hls/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/romoirib/QP/spmv_csc_tmp/spmv_csc/spmv_csc/hls/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
...
integer gmem0_port0_fresh_depth[0:1];
integer gmem0_port0_blank_depth[0:1];

initial begin : runtime_depth_init_process
    gmem0_port0_fresh_depth[0] = 12500;
...
integer gmem0_cur_trans_depth[0:1];

initial begin : out_depth_init_process
    gmem0_cur_trans_depth[0] = 12500;
end
endmodule
