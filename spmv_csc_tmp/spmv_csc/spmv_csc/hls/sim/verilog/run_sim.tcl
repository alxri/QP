...
if {[file isfile spmv_csc.autotvin.dat]} {
	file delete -force spmv_csc.autotvin.dat
}

if {[file isfile spmv_csc.autotvout.dat]} {
	file delete -force spmv_csc.autotvout.dat
}
