...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { nnz_stream_din { O 1032 vector } nnz_stream_full_n { I 1 bit } nnz_stream_write { O 1 bit } nnz_stream_num_data_valid { I 9 vector } nnz_stream_fifo_cap { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_nnz_c \
    op interface \
    ports { nnz_c_din { O 32 vector } nnz_c_full_n { I 1 bit } nnz_c_write { O 1 bit } nnz_c_num_data_valid { I 3 vector } nnz_c_fifo_cap { I 3 vector } } \
} "
}
