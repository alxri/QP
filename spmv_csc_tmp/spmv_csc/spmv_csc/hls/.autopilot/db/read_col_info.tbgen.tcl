...
set portList { 
	...
	{ num_cols sc_in sc_lv 32 signal 0 } 
	...
	{ A_col_ptr sc_in sc_lv 64 signal 2 } 
	...
	{ x_in sc_in sc_lv 64 signal 4 } 
	{ col_info_stream_din sc_out sc_lv 64 signal 5 } 
	{ col_info_stream_full_n sc_in sc_logic 1 signal 5 } 
	{ col_info_stream_write sc_out sc_logic 1 signal 5 } 
	{ col_info_stream_num_data_valid sc_in sc_lv 7 signal 5 } 
	{ col_info_stream_fifo_cap sc_in sc_lv 7 signal 5 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_col_info_Pipeline_VITIS_LOOP_46_1_fu_149", "Port" : "gmem1", "Inst_start_state" : "10", "Inst_end_state" : "11"}]},
			...
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_col_info_Pipeline_VITIS_LOOP_46_1_fu_149", "Port" : "gmem3", "Inst_start_state" : "10", "Inst_end_state" : "11"}]},
			{"Name" : "x_in", "Type" : "None", "Direction" : "I"},
			{"Name" : "col_info_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "col_info_stream_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_col_info_Pipeline_VITIS_LOOP_46_1_fu_149", "Port" : "col_info_stream", "Inst_start_state" : "10", "Inst_end_state" : "11"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_col_info_Pipeline_VITIS_LOOP_46_1_fu_149", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_col_info_Pipeline_VITIS_LOOP_46_1_fu_149.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	num_cols { ap_none {  { num_cols in_data 0 32 } } }
	...
	A_col_ptr { ap_none {  { A_col_ptr in_data 0 64 } } }
