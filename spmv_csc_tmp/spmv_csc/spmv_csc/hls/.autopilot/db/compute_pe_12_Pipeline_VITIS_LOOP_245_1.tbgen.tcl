set moduleName compute_pe_12_Pipeline_VITIS_LOOP_245_1
set isTopModule 0
...
set cdfgNum 62
set C_modelName {compute_pe.12_Pipeline_VITIS_LOOP_245_1}
...
set C_modelArgList {
	...
	{ y_partial float 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "num_rows_12", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "y_partial", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ num_rows_12 sc_in sc_lv 32 signal 0 } 
	{ y_partial_address0 sc_out sc_lv 10 signal 1 } 
	{ y_partial_ce0 sc_out sc_logic 1 signal 1 } 
	{ y_partial_we0 sc_out sc_logic 1 signal 1 } 
	{ y_partial_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	y_partial { ap_memory {  { y_partial_address0 mem_address 1 10 }  { y_partial_ce0 mem_ce 1 1 }  { y_partial_we0 mem_we 1 1 }  { y_partial_d0 mem_din 1 32 } } }
}
