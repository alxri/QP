set moduleName read_nnz_packed_Pipeline_VITIS_LOOP_89_1
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "words", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln89_2", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ nnz_stream_din sc_out sc_lv 1032 signal 6 } 
	{ nnz_stream_full_n sc_in sc_logic 1 signal 6 } 
	{ nnz_stream_write sc_out sc_logic 1 signal 6 } 
	{ nnz_stream_num_data_valid sc_in sc_lv 9 signal 6 } 
	{ nnz_stream_fifo_cap sc_in sc_lv 9 signal 6 } 
	{ words sc_in sc_lv 29 signal 0 } 
	{ sext_ln89 sc_in sc_lv 58 signal 2 } 
	{ sext_ln89_2 sc_in sc_lv 58 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "words", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "words", "role": "default" }} , 
 	{ "name": "sext_ln89", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln89", "role": "default" }} , 
 	{ "name": "sext_ln89_2", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln89_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "134217730"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "134217730"}
]}
...
set Spec2ImplPortList { 
	words { ap_none {  { words in_data 0 29 } } }
	...
	sext_ln89_2 { ap_none {  { sext_ln89_2 in_data 0 58 } } }
