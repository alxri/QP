...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_x_element \
    op interface \
    ports { x_element { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { col_info_stream_din { O 64 vector } col_info_stream_full_n { I 1 bit } col_info_stream_write { O 1 bit } col_info_stream_num_data_valid { I 7 vector } col_info_stream_fifo_cap { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { prev_1_out { O 32 vector } prev_1_out_ap_vld { O 1 bit } } \
} "
}
