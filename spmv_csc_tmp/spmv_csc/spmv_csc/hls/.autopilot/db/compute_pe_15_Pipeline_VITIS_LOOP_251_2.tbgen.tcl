set moduleName compute_pe_15_Pipeline_VITIS_LOOP_251_2
set isTopModule 0
...
set cdfgNum 62
set C_modelName {compute_pe.15_Pipeline_VITIS_LOOP_251_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "pe_streams_15", "interface" : "fifo", "bitwidth" : 97, "direction" : "READONLY"} , 
 	{ "Name" : "num_rows_9", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ pe_streams_15_dout sc_in sc_lv 97 signal 0 } 
	{ pe_streams_15_empty_n sc_in sc_logic 1 signal 0 } 
	{ pe_streams_15_read sc_out sc_logic 1 signal 0 } 
	{ pe_streams_15_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ pe_streams_15_fifo_cap sc_in sc_lv 9 signal 0 } 
	{ num_rows_9 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "num_rows_9", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "num_rows_9", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_no_dsp_1_U289", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U290", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	num_rows_9 { ap_none {  { num_rows_9 in_data 0 32 } } }
