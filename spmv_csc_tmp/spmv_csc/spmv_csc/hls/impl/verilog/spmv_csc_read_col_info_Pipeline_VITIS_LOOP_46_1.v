...
module spmv_csc_read_col_info_Pipeline_VITIS_LOOP_46_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln46_reg_274;
reg    ap_block_pp0_stage0_11001;
reg   [0:0] icmp_ln46_reg_274_pp0_iter1_reg;
reg   [31:0] prev_2_reg_278;
wire   [31:0] col_nnz_fu_203_p2;
reg   [31:0] col_nnz_reg_284;
wire   [0:0] icmp_ln53_fu_208_p2;
reg   [31:0] x_element_1_reg_293;
reg   [31:0] prev_1_fu_68;
wire    ap_loop_init;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg    ap_loop_exit_ready_pp0_iter2_reg;
reg   [31:0] empty_fu_72;
reg   [30:0] col_fu_76;
wire   [30:0] add_ln46_fu_177_p2;
reg   [30:0] ap_sig_allocacmp_col_load;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [31:0] zext_ln46_fu_167_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln46_fu_171_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln46_fu_171_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_sig_allocacmp_col_load = 31'd0;
    end else begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_grp1) & (icmp_ln53_reg_289 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (icmp_ln53_reg_289 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter2_reg == 1'b1) & (icmp_ln46_reg_274_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001_grp1))) begin
        p_out_ap_vld = 1'b1;
    end else begin
        p_out_ap_vld = 1'b0;
    end
...
assign add_ln46_fu_177_p2 = (ap_sig_allocacmp_col_load + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_block_state4_pp0_stage0_iter3_grp1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem3_0_RVALID == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_block_state4_pp0_stage0_iter3_grp1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem3_0_RVALID == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_11001_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_block_state4_pp0_stage0_iter3_grp1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem3_0_RVALID == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_block_state4_pp0_stage0_iter3_grp1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem3_0_RVALID == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_subdone_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_pp0_stage0_iter3_grp1 = ((icmp_ln53_reg_289 == 1'd1) & (col_info_stream_full_n == 1'b0));
end
...
assign col_info_stream_din = {{empty_fu_72}, {col_nnz_reg_284}};

assign col_nnz_fu_203_p2 = (prev_2_reg_278 - prev_1_fu_68);

assign icmp_ln46_fu_171_p2 = (($signed(zext_ln46_fu_167_p1) < $signed(sub)) ? 1'b1 : 1'b0);

assign icmp_ln53_fu_208_p2 = (($signed(col_nnz_fu_203_p2) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign prev_1_out = prev_1_fu_68;

assign zext_ln46_fu_167_p1 = ap_sig_allocacmp_col_load;

endmodule //spmv_csc_read_col_info_Pipeline_VITIS_LOOP_46_1
