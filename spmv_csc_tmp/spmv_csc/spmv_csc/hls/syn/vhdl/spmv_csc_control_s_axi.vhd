...
entity spmv_csc_control_s_axi is
generic (
...
end entity spmv_csc_control_s_axi;
...
architecture behave of spmv_csc_control_s_axi is
    ...
    constant ADDR_NNZ_DATA_0       : INTEGER := 16#20#;
    constant ADDR_NNZ_CTRL         : INTEGER := 16#24#;
    constant ADDR_A_ROW_IDX_DATA_0 : INTEGER := 16#28#;
    constant ADDR_A_ROW_IDX_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_A_ROW_IDX_CTRL   : INTEGER := 16#30#;
    constant ADDR_A_COL_PTR_DATA_0 : INTEGER := 16#34#;
    constant ADDR_A_COL_PTR_DATA_1 : INTEGER := 16#38#;
    constant ADDR_A_COL_PTR_CTRL   : INTEGER := 16#3c#;
    constant ADDR_A_VALUES_DATA_0  : INTEGER := 16#40#;
    constant ADDR_A_VALUES_DATA_1  : INTEGER := 16#44#;
    constant ADDR_A_VALUES_CTRL    : INTEGER := 16#48#;
